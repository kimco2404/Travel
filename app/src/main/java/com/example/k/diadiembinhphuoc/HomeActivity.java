...
import com.example.k.diadiembinhphuoc.DTO.*;
import com.example.k.diadiembinhphuoc.Utility.RecyclerItemClickListener;
...
public class HomeActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            Glide.with(this).load(R.drawable.backgroundbp).into((ImageView) findViewById(R.id.backdrop));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
